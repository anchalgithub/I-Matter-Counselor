 ...
 iosCall = () => {
  ...
  render() {
    return (
     ...
     <ScrollView>
<View style={{backgroundColor:"#ffa576",borderBottomLeftRadius:90,borderBottomRightRadius:90,flex:1, height:90}}>
    <Text style={{fontWeight:'bold',fontSize:20,marginTop:40,fontFamily:"Times New Roman",textAlign:'center',color:'brown'}}> Pending Request Details</Text>
    </View>
 ...
 <Text style={{fontWeight:'bold',fontSize:15,marginTop:40,fontFamily:"Times New Roman", paddingLeft:55,color:'brown'}}>
    ...
    <View style={styles.textInput1}>
      ...
      style={{paddingLeft:10, fontFamily:'Times New Roman'}}
           value={this.state.counselorComments}
          onChangeText={(val)=>{
            this.setState({counselorComments:val})
          }}
...
<View style={{marginTop:10}}>
 ...
 <TouchableOpacity
  onPress={this.dialCall}
          activeOpacity={0.7}
          style={{marginLeft:'45%', marginTop:-41}}>
...
<TouchableOpacity
          style={{marginLeft:'65%', marginTop:-23}}
           onPress={this.onReply}>
           <Entypo name="reply" size={23} color="#ffa585" />
        </TouchableOpacity>
